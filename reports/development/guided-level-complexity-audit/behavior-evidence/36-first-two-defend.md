...
| `move_up_screen_1` | `battlegorithms_move_up_screen` | Move Up (screen) | 6 | fired |
...
| --- | --- | --- | --- | --- |
| `on_each_turn_1` | `battlegorithms_on_each_turn` | battlegorithms_on_each_turn | 0 | never fired |
| `if_boolean_else_1` | `battlegorithms_if_boolean_else` | If [boolean] else | 36 | fired |
| `value_compare_1` | `battlegorithms_value_compare` | compare | 36 | fired |
| `value_runner_index_1` | `battlegorithms_value_runner_index` | my runner index | 0 | never fired |
| `value_number_1` | `battlegorithms_value_number` | number | 0 | never fired |
| `if_have_enemy_flag_else_1` | `battlegorithms_if_have_enemy_flag_else` | If I Have Enemy Flag | 12 | fired |
...
| `if_teammate_has_flag_else_1` | `battlegorithms_if_teammate_has_flag_else` | If Teammate Has Enemy Flag | 24 | fired |
| `move_toward_3` | `battlegorithms_move_toward` | Move Toward | 0 | never fired |
| `if_boolean_else_2` | `battlegorithms_if_boolean_else` | If [boolean] else | 24 | fired |
| `value_compare_2` | `battlegorithms_value_compare` | compare | 24 | fired |
...
| `move_forward_1` | `battlegorithms_move_forward` | Move Forward | 12 | fired |
| `if_boolean_else_3` | `battlegorithms_if_boolean_else` | If [boolean] else | 12 | fired |
| `value_compare_3` | `battlegorithms_value_compare` | compare | 12 | fired |
...
| `if_can_jump_else_1` | `battlegorithms_if_can_jump_else` | If I Can Jump | 12 | fired |
| `jump_forward_1` | `battlegorithms_jump_forward` | Jump Forward | 1 | fired |
| `move_forward_2` | `battlegorithms_move_forward` | Move Forward | 11 | fired |
