# Guided Reference Behavior Evidence: Level 7: Watch the Wall
...
- dossier link: [dossier](../level-dossiers/08-watch-the-wall.md)
...
- one-off reference: pass
  - fixture path: `tests/unit/fixtures/guided-reference-solutions/watch-the-wall.xml`
  - turns elapsed: 5
...
| --- | --- | --- | --- | --- | --- | --- |
| one-off reference | pass | 5 | Team 1: 0, Team 2: 0 | 5 | no | none observed |
...
| --- | --- | --- | --- | --- |
| 1 | `runner_1_AI_AllyP1` | MOVE_DOWN_SCREEN | moved | turn 1 runner runner_1_AI_AllyP1: condition `battlegorithms_if_sensor_matches_else` result=true -> action `battlegorithms_move_down_screen` |
| 2 | `runner_1_AI_AllyP1` | MOVE_DOWN_SCREEN | moved | turn 2 runner runner_1_AI_AllyP1: condition `battlegorithms_if_sensor_matches_else` result=true -> action `battlegorithms_move_down_screen` |
...
### Trace Tail
- turn 1 runner runner_1_AI_AllyP1: condition `battlegorithms_if_sensor_matches_else` result=true -> action `battlegorithms_move_down_screen`
- turn 2 runner runner_1_AI_AllyP1: condition `battlegorithms_if_sensor_matches_else` result=true -> action `battlegorithms_move_down_screen`
...
| --- | --- | --- | --- | --- |
| `f1c46p.3a0e7})MA/Uhq` | `battlegorithms_on_each_turn` | battlegorithms_on_each_turn | 0 | never fired |
| `rV||e;quxahT]2,^W(U]` | `battlegorithms_if_sensor_matches_else` | If | 5 | fired |
| `z`2UzsOV8|`blEWVAx(D` | `battlegorithms_move_down_screen` | Move Down (screen) | 2 | fired |
| `Nq`t~k?M$z8Cj#c7G8BB` | `battlegorithms_move_forward` | Move Forward | 3 | fired |

#### NPC / Enemy Snapshot
## Enemy / NPC Behavior
- runner_2_Npc1: behavior PATROL_INTERCEPT; start (10, 2); frozen yes (995 turns remaining)
