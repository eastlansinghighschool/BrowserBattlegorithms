...
export default {
  ...
  tutorialSteps: [
    { id: "level-23-and", title: "Both Must Be True", body: "AND is useful for a one-time power: close enough to matter, and still ready to use. That is how the shared program decides when to spend its freeze.", targetSelector: "#blockly-region" },
