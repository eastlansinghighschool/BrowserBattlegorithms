...
| [Plan 56](plan-56-cell-inspector-tooltip.md) | ready | DOM hover/tap cell inspector overlay layered over the p5 canvas. Shows coordinate plus all entities on the cell (runners with side/control/index/frozen/flag-carry/resources, flags, barriers, level goal, flag bases). Allies and enemies symmetric. Hover + tap-to-pin + ESC. `aria-live` mirror for screen readers. Always on; no toggle. |
