# Guided Reference Behavior Evidence: Level 5: Forward Works Both Ways
...
- dossier link: [dossier](../level-dossiers/05-mirror-forward.md)
...
- one-off reference: pass
  - fixture path: `tests/unit/fixtures/guided-reference-solutions/mirror-forward.xml`
  - turns elapsed: 3
...
**Static/Frozen NPCs:**
- `runner_2_Npc1`: behavior PATROL_INTERCEPT, starting cell (1, 2) (frozen/static)
- `runner_2_Npc2`: behavior PATROL_INTERCEPT, starting cell (1, 6) (frozen/static)
...
| --- | --- | --- | --- | --- |
| `8x)MN5:yaWl56T2,`)JM` | `battlegorithms_on_each_turn` | battlegorithms_on_each_turn | 0 | never fired |
| `5sX@;+x_1CgPj:1f2M4c` | `battlegorithms_move_forward` | Move Forward | 3 | fired |

#### NPC / Enemy Snapshot
## Enemy / NPC Behavior
- runner_2_Npc1: behavior PATROL_INTERCEPT; start (1, 2); frozen yes (997 turns remaining)
- runner_2_Npc2: behavior PATROL_INTERCEPT; start (1, 6); frozen yes (997 turns remaining)
