# Guided Level Dossier: Level 27: Flip The Answer
...
- project: `strategy-brain step 5`

## Curriculum Row
- focus: Flip the answer
- new vocabulary: opposite condition
- new Blockly: NOT
...
## Lesson Copy
- objective: Use NOT to reverse a boolean check.
- intro: NOT turns a true test into a false one and vice versa, which is often the cleanest way to say what you mean.  Use NOT to flip on my side into not on my side. That lets the Strategy Brain react after it crosses midfield.
- tips: not found
- tutorial steps:
  - 1. Reverse The Boolean (level-25-not)
    - body: NOT is useful when the easier idea to say is the opposite of what you want to test. Your shared program can express the idea either way.
    - demo Blockly: not found
  - 2. Change After Crossing (level-25-side)
    - body: NOT reverses whatever boolean it wraps — a true becomes false and a false becomes true. Think about which condition is easier to express, and whether flipping it gets the Strategy Brain what it needs.
    - demo Blockly: not found
...
- Project step fixture 5: `tests/unit/fixtures/guided-project-solutions/strategy-brain/step-05.xml`
  - metrics: blocks 6; distinct types 6; actions 2; conditions 1; boolean/comparison/value 2; max depth 4; decision points 2; runner index 0; resource readiness 0
  - distinct block types: 6 types: `battlegorithms_boolean_on_my_side`, `battlegorithms_if_boolean_else`, `battlegorithms_logic_not`, `battlegorithms_move_forward`, `battlegorithms_move_up_screen`, `battlegorithms_on_each_turn`
...
## Facts Only
- shared workspace project strategy-brain step 5
- concept focus present: Flip the answer
- starter XML contains 1 blocks
- project fixture XML present (2 files)
- toolbox exposes 33 authored block types

## Validation Pointers
- Readiness command: npm run level:readiness -- --level flip-the-answer --json
- Linter command: npm run lint:levels
- Project step fixture: tests/unit/fixtures/guided-project-solutions/strategy-brain/step-05.xml
- Project final fixture: tests/unit/fixtures/guided-project-solutions/strategy-brain/final.xml
