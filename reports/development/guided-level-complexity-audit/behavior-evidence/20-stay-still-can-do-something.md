...
| --- | --- | --- | --- | --- |
| 1 | `runner_1_AI_AllyP1` | STAY_STILL | illegal_noop | turn 1 runner runner_1_AI_AllyP1: condition `battlegorithms_if_sensor_matches_else` result=true -> action `battlegorithms_stay_still` |
