...
export default {
  ...
  introText: "This is the final solo test of the Strategy Brain project. Two defenders are live, and your shared program should now do the whole job before team programming begins.",
  tips: [
