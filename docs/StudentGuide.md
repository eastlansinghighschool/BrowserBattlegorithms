...
- Some guided levels are prediction checkpoints: read the starter code, choose an answer before you press **Start Level**, then compare what happened after the run ends.
...
- Advanced levels and free play include:
  ...
  - `runner index`
  - `distance to [target]`
- Prediction levels ask you to commit to a result before running, so they are a good place to practice tracing before you change code.
