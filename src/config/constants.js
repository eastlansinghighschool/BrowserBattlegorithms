...
export const BLOCKLY_TRACE_SPEED_THRESHOLD = 0.5;
export const BLOCKLY_TRACE_MAX_STEPS = 6;
export const BLOCKLY_TRACE_MAX_DURATION_FRAMES = 60;
export const BLOCKLY_TRACE_MIN_FRAMES_PER_STEP = 10;
...
export const TURN_STATES = {
  ...
  TRACING_PRE_ACTION: "TRACING_PRE_ACTION",
...
export function isBlocklyTraceCollectionActive(state) {
  const animationSpeedFactor = Number(state?.animationSpeedFactor);
  return Number.isFinite(animationSpeedFactor) && animationSpeedFactor <= BLOCKLY_TRACE_SPEED_THRESHOLD;
}
