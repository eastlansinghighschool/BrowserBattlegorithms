# Guided Reference Behavior Evidence: Level 1: Move to Target
...
- dossier link: [dossier](../level-dossiers/01-move-to-target.md)
...
- one-off reference: pass
  - fixture path: `tests/unit/fixtures/guided-reference-solutions/move-to-target.xml`
  - turns elapsed: 3
...
#### NPC / Enemy Snapshot
## Enemy / NPC Behavior
- runner_2_Npc1: behavior PATROL_INTERCEPT; start (10, 1); frozen yes (997 turns remaining)
